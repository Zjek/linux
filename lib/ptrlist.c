...
EXPORT_SYMBOL_GPL(ptr_list_size);
...
EXPORT_SYMBOL_GPL(ptr_list_empty);
...
EXPORT_SYMBOL_GPL(ptr_list_multiple);
...
EXPORT_SYMBOL_GPL(first_ptr_list);
...
EXPORT_SYMBOL_GPL(last_ptr_list);
...
EXPORT_SYMBOL_GPL(ptr_list_nth_entry);
...
EXPORT_SYMBOL_GPL(linearize_ptr_list);
...
EXPORT_SYMBOL_GPL(pack_ptr_list);
...
void split_ptr_list_head(struct ptr_list *head)
{
	...
	struct ptr_list *newlist = __alloc_ptrlist();
...
EXPORT_SYMBOL_GPL(__add_ptr_list);
...
EXPORT_SYMBOL_GPL(__add_ptr_list_tag);
...
EXPORT_SYMBOL_GPL(lookup_ptr_list_entry);
...
EXPORT_SYMBOL_GPL(delete_ptr_list_entry);
...
EXPORT_SYMBOL_GPL(replace_ptr_list_entry);
...
EXPORT_SYMBOL_GPL(undo_ptr_list_last);
...
EXPORT_SYMBOL_GPL(delete_ptr_list_last);
...
EXPORT_SYMBOL_GPL(concat_ptr_list);
...
EXPORT_SYMBOL_GPL(copy_ptr_list);
...
EXPORT_SYMBOL_GPL(__free_ptr_list);
